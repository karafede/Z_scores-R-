...
sendmail_options(smtpServer ="http://proxyconf.ricardo-aea.com/squidproxy.pac")
from <- sprintf("<sendmailR@\\%s>", Sys.info()[4])
to <- "<karafede@hotmail.com>"
subject <- "Hello from R"
body <- list("It works!", mime_part(iris))
sendmail(from, to, subject, body,
         control=list(smtpServer="http://proxyconf.ricardo-aea.com/squidproxy.pac"))


require(sendmailR)
from <- "infrar75@gmail.com.com.com"
message = "<HTML><body><b>Hello</b></body></HTML>"
to = c("infrar75@gmail.com.com")
subject = "Test Monitor Alert"
sendmail(from, to, subject, msg = msg,control=list(smtpServer="ASPMX.L.GOOGLE.COM"),headers=list("Content-Type"="text/html; charset=UTF-8; format=flowed"))
